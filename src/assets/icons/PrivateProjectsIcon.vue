<template>
  ...
  >
    <path
      d="M27,4H5C3.3,4,2,5.3,2,7v18c0,1.7,1.3,3,3,3h5.8l-3.9-3.9c-2.5-2.5-2.5-6.7,0-9.2c1.2-1.2,2.9-1.9,4.6-1.9
	c1.7,0,3.3,0.7,4.5,1.8c1.2-1.2,2.8-1.8,4.5-1.8c1.7,0,3.4,0.7,4.6,1.9c2.5,2.5,2.5,6.7,0,9.2L21.2,28H27c1.7,0,3-1.3,3-3V7
    ...
    />
    <path
      d="M23.7,16.3c-0.8-0.8-2-1.3-3.2-1.3s-2.3,0.5-3.2,1.3L16,17.7l-1.3-1.4c-0.8-0.8-2-1.3-3.2-1.3s-2.3,0.5-3.2,1.3
	c-1.7,1.8-1.7,4.6,0,6.4l7,7c0.2,0.2,0.4,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C25.4,20.9,25.4,18.1,23.7,16.3z"
    />
  </svg>
</template>
